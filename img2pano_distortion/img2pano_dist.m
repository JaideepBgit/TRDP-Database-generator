...
%         annotations_dist.annotation.size.height = ymax_crop-ymin_crop+1;
        annotations_dist.annotation.size.width = xmax_crop-xmin_crop+1;
        annotations_dist.annotation.size.height = ymax_crop-ymin_crop+1;
        %display([annotations_dist.annotation.size.width, annotations_dist.annotation.size.height]);
...
%             end
            ...
            annotations_dist.annotation.object(ind_obj).bndbox.xmax = xmax_brect;%_crop;
            annotations_dist.annotation.object(ind_obj).bndbox.xmin = xmin_brect;%_crop;
            annotations_dist.annotation.object(ind_obj).bndbox.ymax = ymax_brect;%_crop;
            annotations_dist.annotation.object(ind_obj).bndbox.ymin = ymin_brect;%_crop;
        end
